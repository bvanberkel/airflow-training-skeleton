...
http_to_gsc = HTTPToCloudStorageOperator(endpoint='https://europe-west2-gdd-airflow-training.cloudfunctions.net/airflow-training-transform-valutas?date={{ ds }}&to=EUR',
                                         bucket="bvb-data",
